...
function MyBusinesses() {
  ...
  const toggleReminder = (id) => {
    setBusinesses(
      businesses.map((business) =>
        business.id === id
          ? { ...business, highlighted: !business.highlighted }
          : business
      )
    );
  };
  ...
  return (
    <div className="container">
      ...
      />
      {showAddBusiness && (
        <NewBusiness onAdd={addBusiness} close={closeAddBusinessComponent} />
      )}
      {detailedBusiness && (
        <BusinessDetails
          business={detailedBusiness}
          closeComponent={closeBusinessDetailsComponent}
